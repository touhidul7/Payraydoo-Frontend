    ...
    <div className='p-4 home-page pt-16 pb-20'>
      ...
      <div className='finance-stack-body rounded-2xl pt-10 pb-10 md:px-20 mx-auto md:max-w-[90%] font-mont mt-6'>
        ...
        <div className='flex flex-col justify-center items-center'>
          ...
          <h2 className='md:text-6xl text-2xl font-semibold mt-2'>Leadership Team</h2>
        </div>
        ...
        <div className='mt-20 mb-20'>
          ...
          <div className='flex flex-col justify-center items-center'>
            ...
            <h2 className='md:text-6xl text-3xl font-semibold mt-2'>Investor Panel</h2>
          </div>
      ...
      <div className='rounded-2xl bg-white md:pb-52 py-16 md:px-22 px-4 mx-auto md:max-w-[90%] font-mont mt-6'>
        <div>
          <h2 className='md:text-6xl text-3xl text-center text-gray-800 font-semibold mb-6 mt-8 '>How It All Started!</h2>
        ...
        <div className='flex flex-col justify-center items-center gap-5 mt-32'>
          <h2 className='gradient-header md:text-4xl text-2xl font-semibold '>Message From</h2>
          <h2 className='md:text-7xl text-4xl font-semibold text-gray-900'>The Founder</h2>
